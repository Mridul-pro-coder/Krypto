    ...
    <div className='flex w-full flex-col md:flex-row  justify-center items-center gradient-bg-services'>
      <div className='flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4'>
        <div className='flex-1 flex flex-col justify-start items-start'>
          ...
          <p className='text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base'>The best choice for buying and selling your crypto assets.</p>

        </div>
      </div>
      <div className='flex flex-col justify-start items-center mf:flex-row mf:justify-between w-full mt-10'>
        <ServiceCard
          color="bg-[#2952e3]"
